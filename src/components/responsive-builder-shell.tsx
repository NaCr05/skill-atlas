...
export function ResponsiveBuilderShell({
  ...
  return (
    <div className="responsive-builder-compact">
      {!open && <button className="button button-primary responsive-builder-trigger" type="button" onClick={onOpen}><Copy size={16} /> {t("打开调用 Builder", "Open invocation Builder")}</button>}
      {open && (
